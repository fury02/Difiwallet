...
exports.default = ({ IDL }) => {
    ...
    const erc721_token = IDL.Service({
        ...
        addRefund: IDL.Func([IDL.Text, IDL.Principal, SubAccount_3], [], ['oneway']),
        availableCycles: IDL.Func([], [IDL.Nat], ['query']),
        backendRefundSettlement: IDL.Func([IDL.Text], [
        ...
        lock: IDL.Func([TokenIdentifier_2, IDL.Nat64, AccountIdentifier_3, SubAccount_3], [Result_6], []),

...
class Secp256k1KeyIdentity extends agent_1.SignIdentity {
    ...
    static fromParsedJson(obj) {
        ...
        return new Secp256k1KeyIdentity(PublicKey_secpk256k1_1.default.fromRaw((0, candid_1.blobFromHex)(publicKeyRaw)), (0, candid_1.blobFromHex)(privateKeyRaw));
    }
    static fromJSON(json) {
        ...
        if (Array.isArray(parsed)) {
            ...
            const pk = publicKey
                ? PublicKey_secpk256k1_1.default.fromRaw((0, candid_1.blobFromUint8Array)(new Uint8Array(publicKey.data)))
                : PublicKey_secpk256k1_1.default.fromDer((0, candid_1.blobFromUint8Array)(new Uint8Array(_publicKey.data)));
            if (publicKey && secretKey && secretKey.data) {
                return new Secp256k1KeyIdentity(pk, (0, candid_1.blobFromUint8Array)(new Uint8Array(secretKey.data)));
            }
            if (_publicKey && _privateKey && _privateKey.data) {
                return new Secp256k1KeyIdentity(pk, (0, candid_1.blobFromUint8Array)(new Uint8Array(_privateKey.data)));
            }
        }
    ...
    static fromSecretKey(secretKey) {
        ...
        const identity = Secp256k1KeyIdentity.fromKeyPair((0, candid_1.blobFromUint8Array)(publicKey), (0, candid_1.blobFromUint8Array)(new Uint8Array(secretKey)));
        return identity;
    }
    /**
     ...
     */
    toJSON() {
        return [(0, candid_1.blobToHex)(this._publicKey.toRaw()), (0, candid_1.blobToHex)(this._privateKey)];
    }
    /**
    ...
    getKeyPair() {
        return {
            secretKey: (0, candid_1.blobFromUint8Array)(new Uint8Array(this._privateKey)),
    ...
    sign(challenge) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, candid_1.blobFromUint8Array)(signature);
        });
    }
}
